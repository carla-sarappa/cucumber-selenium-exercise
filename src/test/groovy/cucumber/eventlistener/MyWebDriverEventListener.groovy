...
class MyWebDriverEventListener implements WebDriverEventListener {
    ...
    void beforeChangeValueOf(WebElement webElement, WebDriver webDriver, CharSequence[] charSequences) {
    ...
    void afterChangeValueOf(WebElement webElement, WebDriver webDriver, CharSequence[] charSequences) {
